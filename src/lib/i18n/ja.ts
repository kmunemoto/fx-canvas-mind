...
export const ja = {
  ...
  history: {
    ...
    stats: {
      ...
      measuring: (n: number, target: number) => `測定中（決着 ${n}件 / 目安 ${target}件）`,
      ...
      needMore: (n: number) => `統計的に意味のある判断には独立した決着があと${n}件必要`,
    },
